...
const WEBSOCKET_URL = 'http://25.18.47.111:9001'; // <-- ЗАМЕНИ НА ВАШ АДРЕС
...
function sendDataViaWebSocket(dataToSend) {
    ...
    try {
        ...
        if (serverResponse.success) {
            console.log("Сервер подтвердил успех. Выполняем анимацию и перенаправление.");
    ...
    // Закрываем соединение, если оно больше не нужно
    socket.close();
};
